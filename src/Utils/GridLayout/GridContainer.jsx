    ...
    >
      {gridLayout.map((GridData, index) => (
        <div
          ...
          className={`bg-white border dark:border-0 border-gray-300 flex flex-col items-center justify-center text-lg rounded-xl lg:text-base md:text-sm sm:text-xs xs:text-xs xxs:text-xs dark:bg-gray-900 dark:border-gray-700 dark:text-white hover:cursor-grab dark:hover:bg-blue-900 hover:bg-blue-100 ${
            cols > 2 ? "draggable-handle" : " "
          }`}
        >
          {GridData.type === "2" ? (
            <SkillCard {...GridData} />
